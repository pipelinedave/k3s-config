...
- [Nucy Phase 1 Migration Plan](guides/nucy-phase1-migration-plan.md) - Minimal migration plan for chores/share to the home NUC while preserving GitOps workflow.
